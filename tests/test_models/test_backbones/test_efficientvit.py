...
# from mmpretrain.models.backbones.efficientvit import CascadedGroupAttention
...
def test_efficientvit():
    ...
    # model = CascadedGroupAttention(32, 32, num_heads=4, attn_ratio=1)
    model = EfficientViT(arch = 'm0')
